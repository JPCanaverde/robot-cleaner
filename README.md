...
Java based web service that navigates an imaginary robotic cleaner through an oil spill in the sea.
...
Based on [this](https://github.com/marshmallow-insurance/java-backend-test), which itself is based on [this](https://gist.github.com/alirussell/9a519e07128b7eafcb50).
